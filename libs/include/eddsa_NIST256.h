...
#ifndef EDDSA_NIST256_H
#define EDDSA_NIST256_H
 ...
 */
extern int EDDSA_NIST256_KEY_PAIR_GENERATE(csprng *R, octet *D, octet *Q);
 ...
 *
	...
	@return 0 or an error code
 */
extern int EDDSA_NIST256_SIGNATURE(bool ph,octet *D, octet *context,octet *M,octet *SIG);
 ...
 */
extern bool EDDSA_NIST256_VERIFY(bool ph,octet *Q,octet *context,octet *M,octet *SIG);
#endif