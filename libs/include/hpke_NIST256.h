 ...
 */
extern int DeriveKeyPair_NIST256(int config_id,octet *SK,octet *PK,octet *SEED);
 ...
 */
extern void HPKE_NIST256_Encap(int config_id,octet *SK,octet *Z,octet *pkE,octet *pkR);
 ...
 */
extern void HPKE_NIST256_Decap(int config_id,octet *skR,octet *Z,octet *pkE,octet *pkR);
 ...
 */
extern void HPKE_NIST256_AuthEncap(int config_id,octet *skE,octet *skS,octet *Z,octet *pkE,octet *pkR,octet *pkS);
 ...
 *
    ...
    @param pkS the Initiators public key
 */
extern void HPKE_NIST256_AuthDecap(int config_id,octet *skR,octet *Z,octet *pkE,octet *pkR,octet *pkS);
 ...
 */
extern void HPKE_NIST256_KeySchedule(int config_id,octet *key,octet *nonce,octet *exp_secret,int mode,octet *Z,octet *info,octet *psk,octet *pskID);
